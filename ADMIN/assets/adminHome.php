            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="CenterRegistration.php">Center Registration</a>
                        </li>
        ...
        <div class="container py-md-4">
            ...
            <div class="witemshny-grids row">
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    ...
                    <h4 class="gdnhy-1 mt-4"><a href="#img">Lorem, ipsum dolor.</a>
                    </h4>
                </div>
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                ...
                <div class="below-section mt-5 pt-lg-3">
                    <div class="copyright-footer">
                        <div class="columns text-left">
                            Computism.All rights reserved. Design by <a href="https://w3layouts.com/" target="_blank">
                                    W3Layouts</a></p>
                        </div>
