...
<head>
    ...
    <title>CenterHome -  Bootstrap Responsive Template | Home :: W3layouts</title>
    <!-- google fonts -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="centerHome.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="addproduct.php">Add Product</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="viewBookings.php">Product Bookings</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="cerviceBookings.php"> service Bookings</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="w3l-witemshny-main py-5">
        <div class="container py-md-4">
            ...
            <div class="witemshny-grids row">
                ...
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="#img" class="d-block zoom"><img src="assets/images/rty.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
