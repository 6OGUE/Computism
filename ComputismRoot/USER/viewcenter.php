    ...
    <div class="blog py-5" id="Newsblog">
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="title-content text-center mb-lg-3 mb-4">
                <h6 class="title-subw3hny mb-1">Our Cenrter</h6>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="author align-items-center">
                                    ...
                                    <ul class="blog-meta">
                                        <li>
                                            <span class="meta-value"></span><a href="viewmoreproducts.php?sid=<?php echo $rs['reg_id'] ?>" class="btn btn-warning" style="color: white; margin-left:10px;"> View Producs</a>
