...
<head>
    ...
    <title>Userhome - Bootstrap Responsive Template | Home :: W3layouts</title>
    <!-- google fonts -->
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                <h1><a class="navbar-brand" href="index.html">
                        COMPUTISM<span class="sub-color"></span>
                    </a></h1>
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="viewcenter.php">View Shops</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Feedback.php">feedabck</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="slider-info banner-view banner-top1">
                    <div class="container">
                        <div class="banner-info header-hero-19">
                            <p class="w3hny-tag">Design , Assemble , Dominate : Your PC , Your Rules !</p>
                            <h3 class="title-hero-19">Unleash the Beast : Custom PC Creation Awaits</h3>
            ...
            <div class="witemshny-grids row">
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <img src="assets/images/d1.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="#img"></a>
                    </h4>
                </div>
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <img src="assets/images/d2.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="#img"></a>
                ...
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <img src="assets/images/d3.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="#img"></a>
                ...
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <img src="assets/images/d4.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-4"><a href="#img"></a>
                ...
                <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <img src="assets/images/rty.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                </div>
                <op style="margin-left: 22px; font-weight:bold;">THE BYTEMASTER</op>
                <op style="margin-left: 210px; margin-top: -23px; font-weight:bold;">THE TECHNO TITAN</op>
                <op style="margin-left: 420px; margin-top: -23px; font-weight:bold;">THE CYBER SLEEK</op>
                <op style="margin-left: 625px; margin-top: -23px; font-weight:bold;">THE CODE NINJA</op>
                <op style="margin-left: 820px; margin-top: -23px; font-weight:bold;">THE BYTE BENDER</op>
                ...
                <div class="col-md-6 mt-md-0">
                    <div class="grids3-info position-relative">
                        ...
                        <div class="w3-grids3-info">
                            <h4 class="gdnhy-1"><a href="">View Shops</a>
                                <a class="w3item-link btn btn-style mt-4" href="viewcenter.php">
                                    Explore  <i class="fas fa-angle-double-right ms-2"></i>
                                </a>
                ...
                <div class="col-md-6 mt-md-0 mt-4 grids3-info2">
                    <div class="grids3-info position-relative">
                        ...
                        <div class="w3-grids3-info second">
                            <h4 class="gdnhy-1"><a href="">View Bookings</a>
                                <a class="w3item-link btn btn-style mt-4" href="ProductBookings.php">
                                    Explore  <i class="fas fa-angle-double-right ms-2"></i>
                                </a>
                            </h4>
        ...
        <div class="container py-md-5 py-3">
            <div class="row bottom-ab-grids">
                ...
                <div class="w3ab-left-top col-lg-6 mt-lg-0 mt-5 ps-lg-5">
                    <br><br><br><br><br>
                    <h3 class="title-w3l mb-2">Design, Build & Own Your Dream PC</h3>
                    <p class="my-3">     </p>
            ...
            <div class="container">
                <div class="row w3l-passion-mid-grids">
                    <div class="col-lg-6 passion-grid-item-info pe-lg-5 mb-lg-0 mb-5">
                        ...
                        <h3 class="title-w3l mb-4">Build your Custom PC now </h3>
                        <p class="mt-3 pe-lg-5">    </p>
                        <div class="w3banner-content-btns">
                            <a href="viewcenter.php" class="btn btn-style btn-primary mt-lg-5 mt-4 me-2">Build pc <i class="fas fa-angle-double-right ms-2"></i></a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="#service" class="title-head mb-3">One-Stop for Building Your Dream PC</a></h4>
                            <p class="text-para">    </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="#service" class="title-head mb-3">Schedule Services with a click</a></h4>
                            <p class="text-para">    </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="#service" class="title-head mb-3">Vast catalogue of products Available</a></h4>
                            <p class="text-para">    </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="w3l-project-in">
                <div class="bottom-info text-center pb-lg-5">
                    <div class="header-section pe-lg-5">
                        ...
                        <h3 class="title-w3l two mb-2">Become a Pc Builder
                        </h3>
                        <p class="mb-2">We only work with the best Centers around the globe</p>
