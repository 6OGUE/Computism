    ...
    <div class="blog py-5" id="Newsblog">
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="row justify-content-center">
                <?php
                $res = mysqli_query($conn, "SELECT * FROM `tb_cart` C , `tb_product` P,`shop` S,`user` u WHERE  C.`centerid`=S.`s_id` AND C.`itemid`= P.`productcode` AND c.`cusid`=u.`uid`AND  C.`status`='Paid' ");
